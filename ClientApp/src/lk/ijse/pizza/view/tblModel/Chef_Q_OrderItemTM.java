...
public class Chef_Q_OrderItemTM {

    private String itemCode;
    private String nameNsize;
    private String qty;

    public Chef_Q_OrderItemTM() {
    }

    public Chef_Q_OrderItemTM(String itemCode, String nameNsize, String qty) {
