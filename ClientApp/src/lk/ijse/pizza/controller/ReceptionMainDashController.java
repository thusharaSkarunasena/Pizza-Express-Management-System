...
public class ReceptionMainDashController implements Initializable {
    ...
    @FXML
    private AnchorPane reciptionAnchPane;
    @FXML
    ...
    public void logOutHBox_onMouseClicked(MouseEvent mouseEvent) {
        ...
        if (action.get() == ButtonType.OK) {
            try {
                ...
                Stage stage = (Stage) this.reciptionAnchPane.getScene().getWindow();
                stage.setScene(temp);
    ...
    public void receptionMainDashIcon_onMouseEntered(MouseEvent mouseEvent) {
        if (mouseEvent.getSource() instanceof ImageView) {
            ...
            switch (icon.getId()) {
                case "customerIcon":
                    selectionTitleLbl.setText("Manage Customers");
                    selectionDescriptionLbl.setText("Click to add, edit, delete, search or view customers");
                    break;
                case "itemIcon":
                    selectionTitleLbl.setText("Manage Items");
                    selectionDescriptionLbl.setText("Click to add, edit, delete, search or view items");
                    break;
                case "orderIcon":
                    selectionTitleLbl.setText("Manage Orders");
                    selectionDescriptionLbl.setText("Click to add, edit, delete, search or view order");
                    break;
            }
    ...
    @FXML
    public void customerIcon_onMouseClicked(MouseEvent mouseEvent) {
        loadReceptionDashBoardOptions("recep_customerManagement", "Customer Management");
    }

    @FXML
    public void itemIcon_onMouseClicked(MouseEvent mouseEvent) {
        loadReceptionDashBoardOptions("recep_itemManagement", "Item Management");
    }

    @FXML
    public void orderIcon_onMouseClicked(MouseEvent mouseEvent) {
        loadReceptionDashBoardOptions("recep_orderManagement", "Order Management");
    }

    public void loadReceptionDashBoardOptions(String fxmlName, String title) {
        try {
            Parent root = FXMLLoader.load(this.getClass().getResource("/lk/ijse/pizza/view/" + fxmlName + ".fxml"));
            Scene temp = new Scene(root);
            Stage stage = (Stage) this.reciptionAnchPane.getScene().getWindow();
            stage.setScene(temp);
            stage.setTitle("Pizza Express >>> Reception's Main DashBoard >>> " + title);
